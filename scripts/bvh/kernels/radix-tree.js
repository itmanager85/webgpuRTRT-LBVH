...
class RadixTree {
    ...
    UNIFORM_BUFFER;
     ...
     // Z_IDX_BUFFER, NUM_TRIS
    prepare_buffers(KEY_BUFFER, SIZE) {
        ...
        this.PARENT_BUFFER  = this.device.createBuffer({
            size: SIZE * 8,
    ...
    async execute() {
        ...
        return { PARENT_BUFFER : this.PARENT_BUFFER }
    }
